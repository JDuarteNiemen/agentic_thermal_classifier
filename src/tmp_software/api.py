...
def FastTMP(accession: str, model: str,) -> FastState:
    ...
    os.makedirs(f'TMP_results/accessions/{accession}', exist_ok=True)
    WriteJson(metadata, f'TMP_results/accessions/{accession}/{accession}')
    ...
    # paper info
    'paper_dir': f'TMP_results/accessions/{accession}/library/accession_lit',
    'host_paper_dir': None,
    'host_paper': None,
    'thermal_paper': None,
    ...
    # Remove papers
    subprocess.run(f'rm -rf TMP_results/accessions/{accession}/library/*', shell=True)
...
def DemocraticTMP(accession: str, model: str) -> DemocraticState:
    ...
    os.makedirs(f'TMP_results/accessions/{accession}/reasoning', exist_ok=True)
    WriteJson(metadata, f'TMP_results/accessions/{accession}/{accession}')
    ...
    result = graph.invoke({
        ...
        'thermal_reasoning_file': f'TMP_results/accessions/{accession}/reasoning/reasoning.txt',


        # paper info
        'paper_dir': f'TMP_results/accessions/{accession}/library/accession_lit',
        'paper_dir_size': 0,
        'host_paper_dir': f'TMP_results/accessions/{accession}/library/host_lit',
...
def SummaryTMP(accession: str, model: str) -> SummaryState:
    ...
    result = graph.invoke({
        ...
        #paper info
        'summary_file': f'TMP_results/accessions/{accession}/summary/summary.txt',
        'paper_dir': f'TMP_results/accessions/{accession}/library/accession_lit',
        'paper_dir_size': 0,
